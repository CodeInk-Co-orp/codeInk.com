            ...
            scrollDirection: Axis.horizontal,
             child: Row(
               children: [
                  ...
                  subtitle: "In the realm of payment integration, We specialize in implementing secure and user-friendly payment solutions using popular providers like Stripe, PayPal,Apple Pay and Braintree. We ensure that all payment integrations follow industry standards for security, encryption, and data handling to safeguard user information and maintain a smooth, reliable transaction process."
                  ),
                  SizedBox(
                    width: horizontalSpace(context, 0.03),
                  ),
                  ...
                  title: "Logo Designs", 
                  subtitle: "We specialize in creating distinctive, memorable logos that capture the essence of a brand and make a lasting impression. Our logo design approach combines creativity with strategic thinking to ensure each logo resonates with the target audience and stands out in a competitive market. From minimalist marks to complex logos, we work closely with clients to craft visuals that represent their unique identity."
                  ),                        
               ],               
             ),
           ),
